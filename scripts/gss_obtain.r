#### Preamble ####
# NOTICE: YOU ONLY NEED TO RUN THIS ONCE AT THE BEGINNING OF YOUR JOURNEY
# Purpose: The purpose of this code is to clean-up the survey data obtained 
...
# to the dataset. You will end up with a dataset called kids.csv.
# Authors: Bilal Haq
...
# Pre-reqs: You need to have downloaded the data from the library. To do that: 
  ...
  ## help you too much).
  ## 5. Crtl F 'KIDS', click
  ## 6. Click "Data" on the one you want.
  ## 7. Click download
...
# Check: 
  ## You WILL need to change the raw data name.
...
dict <- read_lines("inputs/data/labels.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("inputs/data/labels.txt")
